...
manages the [Ollama Pi](https://docs.ollama.com/integrations/pi) package [Pi-Studio](https://github.com/omaclaren/pi-studio) response view modes. It eliminates the manual friction   
of switching between "Working" (raw token stream) and "Preview" (formatted          
markdown) views, providing a seamless, hands-free experience during AI interactions.
...
#### Demo
<a href="https://campsoftware.com/blog/postMedia/20260507-ai-ollama-pi-studio-activity/PiStudioActivity.mp4" target="_blank">▶️ Play with Sound (opens new tab)</a>
